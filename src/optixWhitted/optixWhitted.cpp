                     ...
                     const float3 &z) -> GeometryInstance
{
    ...
    triangle["x"]->setFloat(make_float3(make_float4(x)*trans) + make_float3(0.0, 0.0,-1.0));
    triangle["y"]->setFloat(make_float3(make_float4(y)*trans) + make_float3(0.0, 0.0,-1.0));
    triangle["z"]->setFloat(make_float3(make_float4(z)*trans) + make_float3(0.0, 0.0,-1.0));
